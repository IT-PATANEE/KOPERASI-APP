                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    try {
                      ...
                      print('ชื่อที่ส่งไป คือ ${memberName}');
                      print('เลขที่สมาชิก คือ ${widget.br_no}-01-${widget.member_no}');
                      print('ชื่อที่ส่งไป1 คือ ${otherMemberName}');
                      print('เลขที่บัญชี คือ ${_toAccountNo}');
                      print('บัญชีที่เลือก คือ ${selectedType}');
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => LoadQrcodePage(
                            ...
                            toAccountNo: (type == 2 || type == 3 || type == 4)
                                ? _toAccountNo
                                : '', // ใช้ _selectedAccountNo เฉพาะเมื่อ type == 2
                            selectedType: selectedType == '1' ? 1 : 2, // ✅ ส่ง int 1 = บัญชีตัวเอง, 2 = บัญชีผู้อื่น
                          ),
                        ),
                      );
                    } catch (e) {
                    ...
                    return Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          setState(() {
                            _selectedAccount =
                                loans; // กำหนดบัญชีที่เลือกให้กับ _selectedAccount
                            _toAccountNo = generateToAccountNo(
                              brNo: widget.br_no,
                              lcontId: loans['LCONT_ID'] ?? '',
                              code: loans[
                                  'CODE'], // อาจต้องตรวจสอบว่า null หรือไม่
                            );
                            // _toAccountNo = loans[
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    focusedBorder: const OutlineInputBorder(
                        borderSide:
                            BorderSide(color: Color.fromARGB(255, 14, 53, 15))),
                    label: const Text('เลขที่บัญชีเงินฝาก 11 หลัก'),
                    hintStyle: const TextStyle(
                      color: Color.fromARGB(255, 0, 87, 31),
                      fontSize: 16,
                      fontWeight: FontWeight.normal,
                  ...
                  onChanged: (value) {
                    ...
                    if (value.length == 11) {
                      _toAccountNo =
                          toMem; // ก็บค่าบัญชีที่กรอกไว้ใน _toAccountNo
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          // เงื่อนไขแสดงบัญชีสินเชื่อหรือข้อความว่าไม่มีบัญชี
          if (toMem.length == 10)
            _loans.isNotEmpty
                ? Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Row(
                        children: const [
                          Icon(Icons.stop,
                              color: Color.fromARGB(255, 0, 87, 31), size: 30),
                          SizedBox(width: 8),
                          Text(
                            'เลือกบัญชี',
                            style: TextStyle(
