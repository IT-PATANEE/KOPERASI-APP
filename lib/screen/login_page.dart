...
// ====== CustomClipper สำหรับโค้ง ======
class LoginWaveClipper extends CustomClipper<Path> {
  @override
  Path getClip(Size size) {
    final path = Path();

    path.lineTo(0, 80); // เริ่มจากซ้ายล่างสุดของขอบบน
    ...
    path.lineTo(size.width, size.height); // มุมขวาล่าง
    path.lineTo(0, size.height);          // มุมซ้ายล่าง
    path.close();
