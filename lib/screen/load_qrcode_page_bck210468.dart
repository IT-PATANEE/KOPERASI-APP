...
class _LoadQrcodePageState extends State<LoadQrcodePage> {
  ...
  Future<void> generateQrCode() async {
    ...
    Map<String, dynamic> data = {
      ...
      'ref2': (widget.type == 2 || widget.type == 3 || widget.type == 4) && widget.toAccountNo.isNotEmpty
          ? widget.toAccountNo // ใช้ _selectedAccountNo เมื่อ type == 2
      ...
      // 'ref2': widget.ref2, // ใช้ค่าที่ส่งมาจากหน้าก่อนหน้า
